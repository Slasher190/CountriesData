...
from Model.LocationModel import CountriesCollection, StatesCollection, CitiesCollection, IdsModel
...
async def route_get_countries_by_ids(request_body: IdsModel = Body(...)):
...
async def route_get_states_by_ids(request_body: IdsModel = Body(...)):
    ids = request_body.ids
...
async def route_get_cities_by_ids(request_body: IdsModel = Body(...)):
    ids = request_body.ids
